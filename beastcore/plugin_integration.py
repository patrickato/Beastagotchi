...
class PluginIntegrationEngine:
    ...
    def tick(self) -> dict[str, Any]:
            ...
            for item in raw:
                ...
                rows.append({
                    **item,
                    ...
                    "available": bool(item.get("configured") or item.get("installed_custom") or is_enabled),
                    "selected": is_enabled,
                    "protected": protected,
        ...
        return {
            ...
            "plugins.provider_arbitration": dict(resolved.get("arbitration") or {}),
            "plugins.provider_decisions": dict((resolved.get("arbitration") or {}).get("decisions") or {}),
            "plugins.provider_summary": dict((resolved.get("arbitration") or {}).get("summary") or {}),
            "plugins.provider_selection_enabled": bool((resolved.get("arbitration") or {}).get("selection_mutation_enabled", False)),
            "plugins.automatic_failover_enabled": bool((resolved.get("arbitration") or {}).get("automatic_failover_enabled", False)),
