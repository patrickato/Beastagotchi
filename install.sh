...
install -m 0644 "$SRC/docs/archive/drafts/BEASTAGOTCHI_MASTER_README_DRAFT.md" /usr/local/share/beastagotchi/BEASTAGOTCHI_MASTER_README.md
...
install -m 0644 "$SRC/docs/archive/roadmaps/Beastagotchi_Foundation_Roadmap_v2.9.md" /usr/local/share/beastagotchi/Beastagotchi_Foundation_Roadmap.md
...
install -m 0644 "$SRC/docs/archive/matrices/Beastagotchi_Master_Completion_Matrix_v4.7.md" /usr/local/share/beastagotchi/Beastagotchi_Master_Completion_Matrix.md
install -m 0644 "$SRC/docs/archive/continuity/Beastagotchi_Project_Continuity_Audit_v1.0.md" /usr/local/share/beastagotchi/Beastagotchi_Project_Continuity_Audit.md
...
install -m 0644 "$SRC/docs/archive/validation/Beastagotchi_v017_Source_Validation_Report.md" /usr/local/share/beastagotchi/Beastagotchi_v017_Source_Validation_Report.md
install -m 0644 "$SRC/docs/archive/validation/Beastagotchi_v016_Source_Validation_Report.md" /usr/local/share/beastagotchi/Beastagotchi_v016_Source_Validation_Report.md
install -m 0644 "$SRC/docs/archive/validation/Beastagotchi_v015_Source_Validation_Report_20260921.md" /usr/local/share/beastagotchi/Beastagotchi_v015_Source_Validation_Report.md
...
install -m 0644 "$SRC/docs/archive/validation/Beastagotchi_v094_Physical_Validation_Review.md" /usr/local/share/beastagotchi/Beastagotchi_v094_Physical_Validation_Review.md
