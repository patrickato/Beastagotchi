# Beastagotchi Master Completion Matrix v3.0

This is the anti-forgetting ledger. It combines the original Design & Architecture Bible, every A–G roadmap gate, the v0.5–v0.9 physical-test decisions, and the later ideas added during development. Items move from `[ ]` to `[~]` to `[x]`; they are not silently deleted because development attention moved elsewhere.
...
- [x] 8-page carousel: Home / Recon / Networks / Spectrum / Captures / Map / Beast / System
...
- [ ] Begin Expedition
- [ ] end-session recap
- [ ] route/distance/AP/capture/hardware/temp/error/XP summary
...
- [ ] Resource Governor
- [ ] thermal-aware animation/effect budgets
- [ ] per-effect cost classes
...
## Current priority after v0.9.5 physical review

The repeated Matrix work was bug-driven, not a change in product scope. Starting with v0.10.0, development returns to breadth:
