...
echo '[6/6] package'
tar -czf /home/pi/beast-core-validation-v091.tar.gz -C /tmp beast-v091-validation
chown pi:pi /home/pi/beast-core-validation-v091.tar.gz
echo 'Validation complete: /home/pi/beast-core-validation-v091.tar.gz'
